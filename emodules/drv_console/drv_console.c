...
int uart16550_init(uintptr_t reg_addr)
{
	...
	uart16550[UART_REG_IER << uart16550_reg_shift] =
		0x05; // Disable all interrupts
	uart16550[UART_REG_LCR << uart16550_reg_shift] =
		0x13; // Enable DLAB (set baud rate divisor)
